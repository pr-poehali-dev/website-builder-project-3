            ...
            <>
              <div className="glass rounded-2xl p-6">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="whitespace-nowrap text-sm text-muted-foreground">.easysait.ru</span>
                </div>
                ...
                {selected.published && (
                  <div className="mt-4 rounded-xl border border-white/10 bg-white/[0.03] p-4 text-center text-sm">
                    ...
                    <p className="mt-1 font-medium text-gradient">https://{subdomain}.easysait.ru</p>
                  </div>
                )}
              </div>
